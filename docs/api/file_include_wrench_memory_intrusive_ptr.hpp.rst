...
.. _file_include_wrench_memory_intrusive_ptr.hpp:
...
.. toctree::
   ...
   program_listing_file_include_wrench_memory_intrusive_ptr.hpp.rst
...
- ``memory`` (:ref:`file_include_wrench_memory_aligned_heap_allocator.hpp`)

- ``ref_tracker.hpp`` (:ref:`file_include_wrench_memory_ref_tracker.hpp`)
